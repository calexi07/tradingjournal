...
export default function HomePage() {
  async function signInWithDiscord() {
    await supabase.auth.signInWithOAuth({
      provider: 'discord',
      options: {
        redirectTo: 'https://tradingjournal-dzr5.vercel.app/auth/processing',
    ...
    <main className="min-h-screen flex flex-col items-center justify-center bg-[#080c10]">
      <div className="text-center max-w-md px-6">
        ...
        <p className="text-[#8b949e] mb-10 text-lg">
          Jurnalul tau profesional pentru prop trading.
        </p>
        <button
        ...
        <div className="mt-12 grid grid-cols-3 gap-4 text-center">
          <div className="bg-[#0d1117] border border-[#21262d] rounded-xl p-4">
            ...
            <div className="text-xs text-[#8b949e]">Equity Curve</div>
          </div>
          <div className="bg-[#0d1117] border border-[#21262d] rounded-xl p-4">
            <div className="text-2xl mb-2">🎯</div>
            <div className="text-xs text-[#8b949e]">Win Rate & RR</div>
          </div>
          <div className="bg-[#0d1117] border border-[#21262d] rounded-xl p-4">
            <div className="text-2xl mb-2">🔐</div>
            <div className="text-xs text-[#8b949e]">Date Sigure</div>
          </div>
        </div>
      </div>
    </main>
